...
from edu.vsb.dqn.wrappers import *
from edu.vsb.dqn.memory import ReplayMemory

import torch
import torch.optim as optim
import torch.nn.functional as F

from edu.vsb.sim import gym_environment
...
if __name__ == '__main__':
    ...
    # create networks
    policy_net = DQN(n_actions=2).to(device)
