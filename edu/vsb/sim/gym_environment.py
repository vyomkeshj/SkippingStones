...
class gym_environment(gym.Env):
    ...
    def step(self, action):
        ...
        state_received_ret = np.concatenate((state_received, self.previous_experience))
        self.previous_experience = state_received

        return state_received_ret, reward_received, done_status, {}
    ...
    def reset(self):
        ...
        return state_received_ret  # on reset, the observation is only the state of the environment
